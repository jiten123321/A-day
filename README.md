...
between its feet, with rungs at even intervals along it; a snake is a curve
bowed out from the straight line, with a head and two eyes at the top of it.
Both are drawn in a 10×10 space, so they land on the squares whatever size the
board is on the screen.
...
is lost.
Eighteen games, all shared — every move lands on both boards.
